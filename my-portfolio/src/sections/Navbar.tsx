...
function Navbar(){
  ...
  />
        ...
        <div className={`${responsiveNavVisible && "nav-responsive"} nav-items`}>
            <ul className="nav-items-list">
                {
                    sectionLinks.map(({name,link},index) => (
                        <motion.li key={name} className="nav-items-list-item" initial={{ opacity: 0, y: -25 }} animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div className="mav-items-button" initial={{ opacity: 0, y: -25 }}
            ...
            transition={{
              ...
              delay: 0.6,
                ...
                <Button text="Resume" link="/cv-2-0-en.pdf" />
            </motion.div>
        </div>
    </div>
  </nav>
